...
public class Ui {
    ...
    public static class AdventureModeUi {
        public static void printBattleLoopUi() {
            System.out.println("===================================");
            System.out.println("1. 공격");
            System.out.println("2. 교체");
            System.out.println("3. 가방");
        ...
        public static void printShowItemUi(int num) {
            ...
            describe[0] = "1. 몬스터볼 : 평범한 몬스터볼이다.(100$)\n2. 슈퍼볼 : 포획률이 조금 높다.(150$)\n3. 하이퍼볼 : 포획률이 상당히 높다.(300$)\n4. 마스터볼 : 무엇이든지 잡을 수 있을것만 같다.(1000$)";
            describe[1] = "1. 하급 상처약 : 포켓몬의 HP를 30% 회복시켜준다.(100$)\n2. 중급 상처약 : 포켓몬의 HP를 60% 회복시켜준다.(200$)\n3. 고급 상처약 : 포켓몬의 HP를 모두 회복시켜준다.(300$)";
            describe[2] = "1. 이상한 사탕 : 먹으면 강해질것만 같다.(1000$)";
            System.out.println("===================================");
